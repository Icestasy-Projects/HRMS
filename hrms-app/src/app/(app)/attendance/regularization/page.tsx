                ...
                <div key={r.id} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ fontWeight: 600, color: 'var(--text)', margin: 0, fontSize: '0.9rem' }}>
                      {r.work_date} · {r.field === 'check_in' ? 'Check-In' : 'Check-Out'}
                    </p>
                    <p style={{ color: 'var(--muted)', fontSize: '0.82rem', margin: '0.2rem 0 0' }}>
                      {r.current_value ? `${r.current_value} → ` : 'No record → '}{r.requested_value}
                    </p>
                    {r.reason && (
                      <p style={{ color: 'var(--muted)', fontSize: '0.8rem', margin: '0.15rem 0 0', fontStyle: 'italic', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        &ldquo;{r.reason}&rdquo;
                      </p>
                    )}
                    {r.admin_note && (
                      <p style={{ color: 'var(--text)', fontSize: '0.8rem', margin: '0.25rem 0 0', fontWeight: 600 }}>
                        Admin: {r.admin_note}
                      </p>
                    )}
                  </div>
