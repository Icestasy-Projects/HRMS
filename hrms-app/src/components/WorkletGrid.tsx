...
const ICON_MAP: Record<string, React.ReactNode> = {
  ...
  '/attendance/regularization':    <FilePenLine size={26} strokeWidth={1.75} />,
  ...
  '/team/regularization':          <ShieldCheck size={26} strokeWidth={1.75} />,
  '/team/hours':                   <Timer size={26} strokeWidth={1.75} />,
